...
destruct bomb from the Weapons Armory, put it in the bridge, and blow the ship
...
joke you know: Lbhe jdks jskdfj , jdklsjd. The Gothon stops, tries not to
laugh, then busts ut laughing and can't move. While he's laughing you run up and shoot him square
in the head putting him down, then jump trough the Weapon Armory door.

You do a dive roll into the Weapon Armory, crouch and scan the room for more Gothons that might
be hiding.  It's dead quiet, too quiet. You stand up and run to the far aisde of the room and
find the neutron bomb in its container. There's a keypad lock on the box
and you need the code to get the bomb out. If you get the code wrong 10 
times then the lock closes forever and you can't get the bomb. The code is 
3 digits.
""")
...
has an even uglier clown costume than the last. They haven't pulled their weapons out
...
You point your blaster at the bomb under your arm and the Gothons put their hands up and start
to sweat. You inch backward to the door, open it, and then carefully place
the bomb on the floor, pointing your blaster at it. You then jump back through
the door, punch the close button and blast the lock so the Gothons can't
...
pods, and no need to pick one to take. Some of them could be damaged but you don't have time
...
void of spae, then implodes as the hull ruptures, crushing your body into jam jelly.
""")
